<?php
$background_color = $row['bg_color'] ?? '#fff';

?>

<section class="sales-page__section sales-page__section--padding-normal learn-today-use-tomorrow" style="background-color:<?php echo esc_attr( $background_color ); ?>;">
